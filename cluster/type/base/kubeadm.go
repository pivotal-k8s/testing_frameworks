...
type InitConfiguration struct {
	// TODO 	metav1.TypeMeta `json:",inline"`
...
type NodeRegistrationOptions struct {
	...
	// TODO 	Taints []v1.Taint `json:"taints,omitempty"`
...
type BootstrapToken struct {
	...
	// TODO 	TTL *metav1.Duration `json:"ttl,omitempty"`
	// Expires specifies the timestamp when this token expires. Defaults to being set
	// dynamically at runtime based on the TTL. Expires and TTL are mutually exclusive.
	// TODO 	Expires *metav1.Time `json:"expires,omitempty"`
...
type JoinConfiguration struct {
	...
	// TODO 	DiscoveryTimeout *metav1.Duration `json:"discoveryTimeout,omitempty"`
...
type HostPathMount struct {
	...
	// TODO 	PathType v1.HostPathType `json:"pathType,omitempty"`
}
